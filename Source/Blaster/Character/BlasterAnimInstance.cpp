...
//Offset yaw for strafing
	...
	bUseAimOffsets = BlasterCharacter->GetCombatStatee() != ECombatState::ECS_Reloading;
	bTransformRightHand = BlasterCharacter->GetCombatStatee() != ECombatState::ECS_Reloading;
}
